...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/JISSHU_BOTS'>JISSHU BOTS</a></b></blockquote>"""
    ...
    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ : VISHNU\n‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/vis_hnu_bot'>VISHNU.A</a>\n‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ\n‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ\n‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\n‣ ʜᴏsᴛᴇᴅ ᴏɴ  : ᴀʟʟ ᴡᴇʙ\n‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ5.2 [sᴛᴀʙʟᴇ]</b></blockquote>"""    
...
"""
    ...
    FILE_CAPTION = """<b>{file_name}\n\n𝖩𝗈𝗂𝗇➥ https://whatsapp.com/channel/0029VahPgTZCcW4itu3f3e2S</b>"""
...
#verified_{}_completed"""
    ...
    MOVIES_UPDATE_TXT = """<b> ɴᴇᴡ ꜱᴇʀɪᴀʟ ꜰɪʟᴇ ɪꜱ ᴀᴅᴅᴇᴅ ✅
**🍿 Serial Name:** {title}
**🔊 Language :** ᴍᴀʟᴀʏᴀʟᴀᴍ 
ᴜᴩʟᴏᴀᴅᴇᴅ ʙʏ ᴍᴀʟʟᴜ-ᴛᴠ-ꜱᴇʀɪᴀʟ™
...
🆔 ᴜᴘɪ ɪᴅ ➩ <code>vishnugopika177@okicici</code> [ᴛᴀᴘ ᴛᴏ ᴄᴏᴘʏ]
...
Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴀɴᴅ ᴜsᴇ ᴀʟʟ ғᴇᴀᴛᴜʀᴇs😇</b>"""
    ...
    SOURCE_TXT = """<b>
NOTE:
- ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› : ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ⚡
